...
bool handle_drive_request(ball_chaser::DriveToTarget::Request& req, ball_chaser::DriveToTarget::Response& res)
{
	...
	// Publish wheel velocities to /cmd_vel topic which accepts msgs of type geometry_msgs::Twist
...
int main(int argc, char** argv)
{
    ...
    // Define a /drive_bot/command_robot service with a handle_drive_request callback function
    ros::ServiceServer service = n.advertiseService("/ball_chaser/drive_bot/command_robot", handle_drive_request);
